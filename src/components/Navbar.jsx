...
export default function Navbar() {
  ...
  return (
    <header className="bg-white shadow-sm">
      <nav
        aria-label="Global"
        className="mx-auto flex max-w-6xl items-center justify-between p-4 lg:px-14"
      >
        {/* Logo */}
        <div className="flex flex-1">
          <a href="#" className="-m-1.6 p-1.5">
            <img alt="Logo" src={Logo} className="h-7 w-auto" />
          </a>
        </div>

        {/* Center Menus */}
        <PopoverGroup className="hidden lg:flex lg:gap-x-8 mx-auto">
        ...
        <div className="flex justify-end flex-1">
          <button
            className="text-white  bg-[#ff6c37] hover:bg-[#ff8547] font-semibold rounded-md py-[7px] px-5">
            Log in
          </button>
        </div>
      </nav>
